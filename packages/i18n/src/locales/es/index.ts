...
"slashCommandSourceUnavailable": "La lista de comandos no está disponible, así que no se envió nada. Inténtalo de nuevo.",
    ...
    "relativePathUnavailable": "El archivo está fuera del proyecto y no tiene ruta relativa",
...
sklm: {
    ...
    "configSync": {
      ...
      appPasswordSavedHint: "Guardada de forma segura en este dispositivo. Déjala vacía para reutilizarla.",
    ...
    "useCustomEndpoint": "Usar un endpoint personalizado",
    "chooserSubscriptions": "Iniciar sesión con una suscripción",
    "chooserApiKeys": "Conectar con una clave de API",
    "customEndpointDesc": "Cualquier URL compatible con OpenAI o Anthropic",
    "connectionKeyHint": "Pegue una clave de API para conectar y cargar los modelos.",
    "connectionUrlHint": "Introduzca una URL base para conectar y cargar los modelos.",
    ...
    "connectionCatalog_one": "{{count}} modelo conocido para este servicio",
    "connectionCatalog_other": "{{count}} modelos conocidos para este servicio",
    "connectionNoModelList_one": "Este servicio no lista modelos · {{count}} modelo conocido",
    "connectionNoModelList_other": "Este servicio no lista modelos · {{count}} modelos conocidos",
    "changeService": "Cambiar",
    "changeServiceTitle": "Cambiar servicio",
    "modelReasoningTag": "Razonamiento",
    "modelsAutoPicked": "Elegidos entre los modelos recomendados. Ajústelos en Gestionar modelos.",
    "presetOpenai": "OpenAI",
    ...
    apiStyleAutoDetected: "Detectado automáticamente: {{format}}",
    ...
    "serviceRowLabel": "{{name}}. Pulsa Intro para editar; arrastra o usa las flechas arriba y abajo para reordenar.",
    "serviceRowActions": "Acciones para {{name}}",
