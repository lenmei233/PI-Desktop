...
"slashCommandSourceUnavailable": "Liste des commandes indisponible, rien n'a été envoyé. Réessayez.",
    ...
    "relativePathUnavailable": "Ce fichier est hors du projet et n'a pas de chemin relatif",
...
sklm: {
    ...
    "useCustomEndpoint": "Utiliser un endpoint personnalisé",
    "chooserSubscriptions": "Se connecter avec un abonnement",
    "chooserApiKeys": "Se connecter avec une clé API",
    "customEndpointDesc": "Toute URL compatible OpenAI ou Anthropic",
    "connectionKeyHint": "Collez une clé API pour vous connecter et charger les modèles.",
    "connectionUrlHint": "Saisissez une URL de base pour vous connecter et charger les modèles.",
    "connectionChecking": "Connexion…",
    "connectionReady_one": "Connecté · {{count}} modèle trouvé",
    "connectionReady_other": "Connecté · {{count}} modèles trouvés",
    "connectionCatalog_one": "{{count}} modèle connu pour ce service",
    "connectionCatalog_other": "{{count}} modèles connus pour ce service",
    "connectionNoModelList_one": "Ce service ne liste pas ses modèles · {{count}} modèle connu",
    "connectionNoModelList_other": "Ce service ne liste pas ses modèles · {{count}} modèles connus",
    "changeService": "Modifier",
    "changeServiceTitle": "Changer de service",
    "modelReasoningTag": "Raisonnement",
    "modelsAutoPicked": "Choisis parmi les modèles recommandés. Ajustez-les dans Gérer les modèles.",
    "presetOpenai": "OpenAI",
