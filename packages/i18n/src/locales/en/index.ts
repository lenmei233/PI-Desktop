export const en = {
  ...
  chat: {
    ...
    relativePathUnavailable: "That file is outside the project, so it has no relative path",
...
sklm: {
    ...
    connectionKeyHint: "Paste an API key to connect and load models.",
    connectionUrlHint: "Enter a base URL to connect and load models.",
    ...
    connectionCatalog_one: "{{count}} known model for this service",
    connectionCatalog_other: "{{count}} known models for this service",
    connectionNoModelList_one: "This service doesn't list models · {{count}} known model",
    connectionNoModelList_other: "This service doesn't list models · {{count}} known models",
    changeService: "Change",
    changeServiceTitle: "Change service",
    modelReasoningTag: "Reasoning",
    modelsAutoPicked: "Picked from the recommended models. Adjust them in Manage models.",
    presetOpenai: "OpenAI",
