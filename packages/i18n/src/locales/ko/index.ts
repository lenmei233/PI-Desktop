...
export const ko = {
  ...
  chat: {
    ...
    relativePathUnavailable: "이 파일은 프로젝트 밖에 있어 상대 경로가 없습니다",
...
sklm: {
    ...
    useCustomEndpoint: "사용자 지정 엔드포인트 사용",
    chooserSubscriptions: "구독으로 로그인",
    chooserApiKeys: "API 키로 연결",
    customEndpointDesc: "OpenAI 또는 Anthropic 호환 URL",
    connectionKeyHint: "API 키를 붙여 넣으면 연결하고 모델을 불러옵니다.",
    connectionUrlHint: "기본 URL을 입력하면 연결하고 모델을 불러옵니다.",
    connectionChecking: "연결 중…",
    connectionReady_one: "연결됨 · 모델 {{count}}개 발견",
    connectionReady_other: "연결됨 · 모델 {{count}}개 발견",
    connectionCatalog_one: "이 서비스의 알려진 모델 {{count}}개",
    connectionCatalog_other: "이 서비스의 알려진 모델 {{count}}개",
    connectionNoModelList_one: "이 서비스는 모델 목록을 제공하지 않습니다 · 알려진 모델 {{count}}개",
    connectionNoModelList_other: "이 서비스는 모델 목록을 제공하지 않습니다 · 알려진 모델 {{count}}개",
    changeService: "변경",
    changeServiceTitle: "서비스 변경",
    modelReasoningTag: "추론",
    modelsAutoPicked: "추천 모델이 자동으로 선택되었습니다. 모델 관리에서 조정할 수 있습니다.",
    presetOpenai: "OpenAI",
    ...
    apiStyleAutoDetected: "자동 감지: {{format}}",
