...
export const tr = {
  ...
  chat: {
    ...
    relativePathUnavailable: "Dosya proje dışında olduğu için göreli yolu yok",
...
sklm: {
    ...
    useCustomEndpoint: "Özel uç nokta kullan",
    chooserSubscriptions: "Abonelikle oturum aç",
    chooserApiKeys: "API anahtarıyla bağlan",
    customEndpointDesc: "OpenAI veya Anthropic uyumlu herhangi bir URL",
    connectionKeyHint: "Bağlanmak ve modelleri yüklemek için bir API anahtarı yapıştırın.",
    connectionUrlHint: "Bağlanmak ve modelleri yüklemek için bir temel URL girin.",
    connectionChecking: "Bağlanıyor…",
    connectionReady_one: "Bağlandı · {{count}} model bulundu",
    connectionReady_other: "Bağlandı · {{count}} model bulundu",
    connectionCatalog_one: "Bu servis için bilinen {{count}} model",
    connectionCatalog_other: "Bu servis için bilinen {{count}} model",
    connectionNoModelList_one: "Bu servis model listelemiyor · bilinen {{count}} model",
    connectionNoModelList_other: "Bu servis model listelemiyor · bilinen {{count}} model",
    changeService: "Değiştir",
    changeServiceTitle: "Servisi değiştir",
    modelReasoningTag: "Akıl yürütme",
    modelsAutoPicked: "Önerilen modeller seçildi. Modelleri yönet bölümünden değiştirebilirsiniz.",
    presetOpenai: "OpenAI",
    ...
    apiStyleAutoDetected: "Otomatik algılandı: {{format}}",
