...
export const zhCN = {
  ...
  chat: {
    ...
    copyFullPath: "复制完整地址",
    copyRelativePath: "复制相对地址",
    relativePathUnavailable: "该文件不在项目内，没有相对地址",
...
sklm: {
    ...
    useCustomEndpoint: "使用自定义端点",
    chooserSubscriptions: "用订阅登录",
    chooserApiKeys: "用 API Key 连接",
    customEndpointDesc: "任意 OpenAI 或 Anthropic 兼容地址",
    connectionKeyHint: "粘贴 API Key 后自动连接并获取模型。",
    connectionUrlHint: "填写地址后自动连接并获取模型。",
    connectionChecking: "正在连接…",
    connectionReady_one: "已连接 · 发现 {{count}} 个模型",
    connectionReady_other: "已连接 · 发现 {{count}} 个模型",
    connectionCatalog_one: "该服务已知 {{count}} 个模型",
    connectionCatalog_other: "该服务已知 {{count}} 个模型",
    connectionNoModelList_one: "该服务不提供模型列表 · 已知 {{count}} 个模型",
    connectionNoModelList_other: "该服务不提供模型列表 · 已知 {{count}} 个模型",
    changeService: "更换",
    changeServiceTitle: "更换服务",
    modelReasoningTag: "推理",
    modelsAutoPicked: "已按推荐自动选择，可在「管理模型」中调整。",
    presetOpenai: "OpenAI",
    ...
    presetXiaomiTokenPlanAms: "小米 Token 套餐（欧洲）",
