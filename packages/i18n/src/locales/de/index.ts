...
"slashCommandSourceUnavailable": "Befehlsliste nicht verfügbar, es wurde nichts gesendet. Bitte erneut versuchen.",
    ...
    "relativePathUnavailable": "Die Datei liegt außerhalb des Projekts und hat keinen relativen Pfad",
...
sklm: {
    ...
    "useCustomEndpoint": "Eigenen Endpunkt verwenden",
    "chooserSubscriptions": "Mit einem Abo anmelden",
    "chooserApiKeys": "Mit einem API-Schlüssel verbinden",
    "customEndpointDesc": "Jede OpenAI- oder Anthropic-kompatible URL",
    "connectionKeyHint": "Fügen Sie einen API-Schlüssel ein, um zu verbinden und Modelle zu laden.",
    "connectionUrlHint": "Geben Sie eine Basis-URL ein, um zu verbinden und Modelle zu laden.",
    "connectionChecking": "Verbindung wird hergestellt…",
    "connectionReady_one": "Verbunden · {{count}} Modell gefunden",
    "connectionReady_other": "Verbunden · {{count}} Modelle gefunden",
    "connectionCatalog_one": "{{count}} bekanntes Modell für diesen Dienst",
    "connectionCatalog_other": "{{count}} bekannte Modelle für diesen Dienst",
    "connectionNoModelList_one": "Dieser Dienst listet keine Modelle · {{count}} bekanntes Modell",
    "connectionNoModelList_other": "Dieser Dienst listet keine Modelle · {{count}} bekannte Modelle",
    "changeService": "Ändern",
    "changeServiceTitle": "Dienst ändern",
    "modelReasoningTag": "Reasoning",
    "modelsAutoPicked": "Aus den empfohlenen Modellen ausgewählt. Unter „Modelle verwalten“ anpassen.",
    "presetOpenai": "OpenAI",
    ...
    apiStyleAutoDetected: "Automatisch erkannt: {{format}}",
